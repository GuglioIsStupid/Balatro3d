...
function Controller:init()
    self.clicked = {target = nil, handled = true, prev_target = ni;}
    self.focused = {target = nil, handled = true, prev_target = nil}
    ...
    self.GAMEPAD_CONSOLE = 'Nintendo'
    
    self.keyboard_controller = {
        getGamepadMappingString = function() return 'balatro_gamepad' end,
